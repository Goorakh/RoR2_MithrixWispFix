...
namespace MithrixWispFix
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(MithrixWispFix) + @"\";
                ...
                {
                    UnityEngine.Debug.LogError($"[{MithrixWispFixPlugin.PluginName}] Logger failed to determine caller path prefix length");
                    return 0;
                }
            }
        }
